        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.from), withText("Nicoleta Minoiu"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textView.check(matches(withText("Nicoleta Minoiu")));

        ViewInteraction appCompatTextView = onView(
                allOf(withId(R.id.message), withText("hello"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.messageArea), withText("hi"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("how"));

        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.messageArea), withText("how"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.LinearLayout")),
                                        2),
        ...
        ViewInteraction appCompatEditText7 = onView(
                allOf(withId(R.id.messageArea), withText("how"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText7.perform(replaceText("how are you"));

        ViewInteraction appCompatEditText8 = onView(
                allOf(withId(R.id.messageArea), withText("how are you"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.LinearLayout")),
                                        2),
        ...
        ViewInteraction appCompatEditText10 = onView(
                allOf(withId(R.id.messageArea), withText("how are you"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText10.perform(replaceText("good a"));

        ViewInteraction appCompatEditText11 = onView(
                allOf(withId(R.id.messageArea), withText("good a"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.LinearLayout")),
                                        2),
