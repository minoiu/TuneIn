    ...
    public void registrationTest() {
                ...
                allOf(withId(R.id.first_name),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        appCompatEditText.perform(scrollTo(), replaceText("Flavia"), closeSoftKeyboard());
                ...
                allOf(withId(R.id.last_name),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        appCompatEditText2.perform(scrollTo(), replaceText("Turcu"), closeSoftKeyboard());
                ...
                allOf(withId(R.id.email_register),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        appCompatAutoCompleteTextView.perform(scrollTo(), replaceText("fla@tur.com"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatButton2 = onView(
                allOf(withId(R.id.signup_button), withText("Sign up!"),
                        childAtPosition(
                                allOf(withId(R.id.email_register_form),
                                        childAtPosition(
