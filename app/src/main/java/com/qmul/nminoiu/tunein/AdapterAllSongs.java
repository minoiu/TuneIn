...
public class AdapterAllSongs extends BaseAdapter {
    ...
    /**
     * Instantiates a new Adapter all songs.
     *
    ...
    //returning position of given row
    @Override
    public Object getItem(int position) {
        return rowItems.get(position);
    }

    //returning the id of the row
    @Override
    public long getItemId(int position) {
        return rowItems.indexOf(getItem(position));
    }

    //method to return the convert View
    @Override
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        //handling clicks on song options
        try {
                                ...
                                public boolean onMenuItemClick(MenuItem item) {
                                    ...
                                    switch (item.getItemId()) {
                                        ...
                                        case R.id.delete:
                                            ...
                                            delSongRef = FirebaseDatabase.getInstance().getReference().child("MySongs").child(ID);
    ...
    //add song to favourite node in Firebase
    ...
    //add song to favourites liked list
    ...
    //check if song is already in liked list
    ...
    //check if song already in downloads
    ...
    //add song to downloads node in Firebase
