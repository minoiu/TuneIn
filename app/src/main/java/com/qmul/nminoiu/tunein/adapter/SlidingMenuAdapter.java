package com.qmul.nminoiu.tunein.adapter;
...
import com.qmul.nminoiu.tunein.model.ItemSlideMenu;
import java.util.List;


/**
 * Created by nminoiu on 05/06/2017.
 */
...
public class SlidingMenuAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageView img = (ImageView)v.findViewById(R.id.item_title);
        TextView tv = (TextView)v.findViewById(R.id.item_title);

        ItemSlideMenu item = lstItem.get(position);
        img.setImageResource(item.getImgId());
        tv.setText(item.getImgId());
