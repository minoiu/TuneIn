...
/**
 * Created by nicoleta on 20/12/2017
 */
public class Downloads extends AppCompatActivity {
    ...
    private AdapterDownloads adapter;
    private AdapterDownloads searchadapter;
    private String song;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new AdapterDownloads(this, rowItems);
        img = (ImageView) findViewById(R.id.icon);
        FirebaseUser currentuser = firebaseAuth.getCurrentUser();
        String curUser = currentuser.getUid().toString();
        dwnLay = (LinearLayout) findViewById(R.id.downloadsLayout);
        songsList = (ListView) dwnLay.findViewById(R.id.songsList);
        ...
        //initialising floating button for messages
        final FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fab);
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(Downloads.this, Conversations.class);
        ...
        //initialising floating button for homepage
        final FloatingActionButton fab1 = (FloatingActionButton) findViewById(R.id.fab1);
        fab1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(Downloads.this, RealTimeActivity.class);
                if(mediaPlayer.isPlaying()){
                    String song = track_title.getText().toString();
                    i.putExtra("Song", song);
                }
        ...
        //new margins for floating buttons
        ...
        //show playbar if music is playing and reposition floating buttons
        if(mediaPlayer.isPlaying()){
        ...
        //get currently playing song from Firebase
        ...
        //handling clicks on downloaded songs list
        ...
        //retrieving downloaded songs and attaching custom adapter
        db = FirebaseDatabase.getInstance().getReference().child("DownloadedSongs").child(ID);
    ...
    //start song and set pause button on play toolbar
    ...
    //handling click on back arrow and opening previous intent
    @Override
    ...
    /**
     * Erase from homepage node Firebase.
     */
